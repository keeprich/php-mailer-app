...
<head>
    ...
    <style type="text/css">
        ...
        h1{
            font-size: 72px;
  background: -webkit-linear-gradient(#2ef, #333);
...
<body>
    ...
    <h1 class="text-center">Send Email With PhpMailer</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-md-offset-3" align="center">
                ...
                <input type="button" onclick="sendEmail()" value="Send An Email" class="btn btn-success">
            </div>
        </div>
    </div>
    <br><br><br><br><br>
